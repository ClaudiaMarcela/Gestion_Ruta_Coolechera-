...
public class BuscarClienteActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.buscar_cliente_activity);
		
		//cargar referencia y agregar captura de evento de busqueda.
		search=(SearchView) findViewById(R.id.searchViewBuscarCliente);
		...
		listView = (ListView) findViewById(R.id.listaClientesEncontrados);
	 ...
	 * @param text
	 */
	protected void buscarCliente(String text) {
		
		//lista de clientes cargados.
		listaClientes = DataBaseBO.buscarClientes(text, this.getBaseContext());
	...
	/**
	 * metodo para validar que la fecha de labores coincida con la fecha actual del telefono, de estas las fechas sincronizadas
	...
	protected void mostrarAlertDialogIniciarDia() {
		AlertDialog.Builder builder = new AlertDialog.Builder(BuscarClienteActivity.this);
